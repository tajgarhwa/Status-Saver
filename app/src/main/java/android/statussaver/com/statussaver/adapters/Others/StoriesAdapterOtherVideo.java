package android.statussaver.com.statussaver.adapters.Others;
...
public class StoriesAdapterOtherVideo extends RecyclerView.Adapter<StoriesAdapterOtherVideo.ViewHolder> {
    ...
    public StoriesAdapterOtherVideo(ArrayList<File> statuslist, Context mContext) {
