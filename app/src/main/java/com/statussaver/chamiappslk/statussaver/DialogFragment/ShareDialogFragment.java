...
public class ShareDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void setListner(MyDialogListener listner){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialogfragment_share, container, false);
...
//    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnyes:
                mListener.onLeftClicked(ShareDialogFragment.this);
                break;
            case R.id.btnNo:
                mListener.onRightClicked(ShareDialogFragment.this);
                break;
